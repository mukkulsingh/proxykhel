...
class LeaderBoardModel {
  ...
  Future<LeaderBoardDetail> getLeaderBoardDetail(String matchId, String contestId) async {
    String userId = await SavedPref.instance.getUserId();
    http.Response response = await http.post(
      "https://www.proxykhel.com/android/score.php",
      body:{
...
class LeaderBoardDetail {
  ...
  factory LeaderBoardDetail.fromJson(Map<String, dynamic> json) => new LeaderBoardDetail(
...
class Datum {
  ...
  factory Datum.fromJson(Map<String, dynamic> json) => new Datum(
    ...
    fantasyWinningPlayersPoint: new List<Map<String, AllRounder>>.from(json["FantasyWinningPlayersPoint"].map((x) => new Map.from(x).map((k, v) => new MapEntry<String, AllRounder>(k, AllRounder.fromJson(v))))),
  ...
  Map<String, dynamic> toJson() => {
    ...
    "FantasyWinningPlayersPoint": new List<dynamic>.from(fantasyWinningPlayersPoint.map((x) => new Map.from(x).map((k, v) => new MapEntry<String, dynamic>(k, v.toJson())))),
...
class FantasyWinningPoint {
  ...
  factory FantasyWinningPoint.fromJson(Map<String, dynamic> json) => new FantasyWinningPoint(
...
class ManOfTheMatch {
  ...
  factory ManOfTheMatch.fromJson(Map<String, dynamic> json) => new ManOfTheMatch(
...
class Teamdata {
  ...
  factory Teamdata.fromJson(Map<String, dynamic> json) => new Teamdata(
    id: json["id"],
    userId: json["userId"],
