...
class GetContestTypePartialModel{
  static GetContestTypePartialModel _instance;

  static GetContestTypePartialModel get instance{
    if(_instance == null){
      _instance = new GetContestTypePartialModel();
    }
    return _instance;
  }
  ...
  Future<GetContestTypePartial> getContestPartial(String matchId) async {
    ...
    if(response.statusCode == 200){
      ...
      if(res['success'] == true){
        GetContestTypePartial contestList = getContestTypePartialFromJson(response.body);
        return contestList;
      }else{
        return null;
      }
...
GetContestTypePartial getContestTypePartialFromJson(String str) => GetContestTypePartial.fromJson(json.decode(str));

String getContestTypePartialToJson(GetContestTypePartial data) => json.encode(data.toJson());

class GetContestTypePartial {
  bool success;
  List<Datum> data;

  GetContestTypePartial({
    this.success,
    this.data,
  });

  factory GetContestTypePartial.fromJson(Map<String, dynamic> json) => GetContestTypePartial(
