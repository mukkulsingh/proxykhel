...
import './../Model/verifyphoneafterlogin.model.dart';
import 'dart:math';
                        ...
                        _isSubmitButtonLoading ?new Center(child: new CircularProgressIndicator(),):new Container(
                          ...
                          child: new RaisedButton(
                            onPressed: () async {
                              ...
                              if( await VerifyPhoneAfterLoginModel.instance.verifyOTP(_OTP)){
                      ...
                      _resendOtpVisibility? _isResendButtonLoading ? new Center(child: new CircularProgressIndicator(),) : new Container(
                        ...
                        child: new FlatButton(
                          ...
                          onPressed: ()async{
                            ...
                            VerifyPhoneAfterLoginModel.instance.setOTP(otp);
                            int contact = VerifyPhoneAfterLoginModel.instance.getContact();
